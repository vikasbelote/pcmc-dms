...
public class BuildingPermissionRepository extends BaseRepository {
	...
	public List<BuildingPermissionModel> getBuildingPermissionList(BuildingPermissionModel model){
		...
		sb.append("select row_id,village_name,serve_no,cts_no,architect_name,owner_name,building_permission_no ");
		...
		sb.append("and cts_no like CONCAT(TRIM(IFNULL('" + model.getCtsNo()  + "', '')), '%') ");

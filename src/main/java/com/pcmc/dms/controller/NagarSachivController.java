...
@Controller
public class NagarSachivController extends BaseController {
	 ...
	 */
	private static final String UPLOAD_URL = "uploadNagarSachiv";

	private static final String SEARCH_URL = "nagarSachiv";
	
	/*
	 * View URL name and View name
	 */
	private static final String VIEW_URL = "viewNagarSachiv";
	
	private static final String MODEL_NAME = "nagarSachivModel";
	
	private static final String SEARCH_VIEW_NAME = "searchNagarSachiv";

	@RequestMapping(value = "/" + SEARCH_URL, method = RequestMethod.GET)
	public ModelAndView index() {
		
		List<BodyMaster> bodyList = repository.getMasterList(BodyMaster.class);
		
		ModelAndView modelAndView = new ModelAndView(SEARCH_VIEW_NAME, MODEL_NAME, new NagarSachivModel());
		...
		modelAndView.addObject("bodyList", bodyList);
		return modelAndView;
	}
	
	@RequestMapping(value = "/" + SEARCH_URL, method = RequestMethod.POST)
	public ModelAndView search(@ModelAttribute(MODEL_NAME) NagarSachivModel model) {
		
		List<BodyMaster> bodyList = repository.getMasterList(BodyMaster.class);
		List<NagarSachivModel> list = repository.getModelList(model);

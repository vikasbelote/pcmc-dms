...
@Controller
public class PrashasanController extends BaseController {
	@Autowired
	 ...
	 */
	private static final String UPLOAD_URL = "uploadPrashasan";

	private static final String SEARCH_URL = "prashasan";
	
	/*
	 * View URL name and View name
	 */
	private static final String VIEW_URL = "viewPrashasan";
	
	private static final String MODEL_NAME = "prashasanModel";
	
	private static final String SEARCH_VIEW_NAME = "searchPrashasan";

	@RequestMapping(value = "/" + SEARCH_URL, method = RequestMethod.GET)
	public ModelAndView index() {
		
		List<TableMaster> tableMasterList = repository.getMasterList(TableMaster.class);
		
		ModelAndView modelAndView = new ModelAndView(SEARCH_VIEW_NAME, MODEL_NAME, new PrashasanModel());
	...
	public ModelAndView search(@ModelAttribute(MODEL_NAME) PrashasanModel model) {
		
		List<TableMaster> tableMasterList = repository.getMasterList(TableMaster.class);
		List<PrashasanModel> list = repository.getModelList(model);
	...
	public ModelAndView viewPropTax(@RequestParam(value = "id", required = false) int entryId,  HttpSession session) {
		...
		String LOCAL_FOLDER_PATH = "C:\\images\\prashasan\\";

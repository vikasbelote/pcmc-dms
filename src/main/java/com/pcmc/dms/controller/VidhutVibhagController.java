...
@Controller
public class VidhutVibhagController extends BaseController {
	 ...
	 */
	private static final String UPLOAD_URL = "uploadVidhutVibhag";

	private static final String SEARCH_URL = "vidhutVibhag";
	
	/*
	 * View URL name and View name
	 */
	private static final String VIEW_URL = "viewVidhutVibhag";
	
	private static final String MODEL_NAME = "vidhutVibhagModel";
	
	private static final String SEARCH_VIEW_NAME = "searchVidhutVibhag";

	@RequestMapping(value = "/" + SEARCH_URL, method = RequestMethod.GET)
	public ModelAndView index() {
		
		ModelAndView modelAndView = new ModelAndView(SEARCH_VIEW_NAME, MODEL_NAME, new VidhutVibhagModel());
	...
	public ModelAndView search(@ModelAttribute(MODEL_NAME) VidhutVibhagModel model) {
		
		List<VidhutVibhagModel> list = repository.getModelList(model);

...
public class VivahNodhaniTemplate extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
        ...
        header.createCell(0).setCellValue("Prabhag Name");
        ...
        header.createCell(3).setCellValue("Registration Date");
        header.getCell(3).setCellStyle(style);
        
        header.createCell(4).setCellValue("Gatta Number");

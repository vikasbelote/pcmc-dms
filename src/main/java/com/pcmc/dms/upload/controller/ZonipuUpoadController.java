...
import com.pcmc.dms.upload.service.ZonipuService;

@Controller
public class ZonipuUpoadController {
	
	@Autowired
	private ZonipuService service;
	
	//Just change department name
	private static final String DEPT_NAME = "Zonipu";

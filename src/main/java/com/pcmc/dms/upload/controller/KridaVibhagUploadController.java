...
import com.pcmc.dms.upload.service.KridaVibhagService;

@Controller
public class KridaVibhagUploadController {
	
	@Autowired
	private KridaVibhagService kridaVibhagService;
	
	private static final String UPLOAD_URL = "uploadDataKridaVibhag";
	
	private static final String DOWNLOAD_URL = "downloadDataKridaVibhag";
	
	private static final String VIEW_NAME = "kridaVibhagTemplate";
	...
	public String upload(@RequestParam CommonsMultipartFile file, HttpSession session, final RedirectAttributes redirectAttributes) {
		...
		try {
			...
			kridaVibhagService.readBooksFromExcelFile(filePath);

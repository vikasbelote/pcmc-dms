...
import com.pcmc.dms.upload.service.FireBrigadeService;

@Controller
public class FireBrigadeUploadController {
	
	@Autowired
	private FireBrigadeService service;
	
	//Just change department name
	private static final String DEPT_NAME = "FireBrigade";

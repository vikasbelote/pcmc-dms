...
import com.pcmc.dms.upload.service.VivahNodhaniService;

@Controller
public class VivahNodhaniUploadController {
	
	@Autowired
	private VivahNodhaniService vivahNodhaniService;
	
	private static final String UPLOAD_URL = "uploadDataVivahNodhani";
	
	private static final String DOWNLOAD_URL = "downloadDataVivahNodhaniTemplate";
	
	private static final String VIEW_NAME = "vivahNodhaniTemplate";
	...
	public String upload(@RequestParam CommonsMultipartFile file, HttpSession session, final RedirectAttributes redirectAttributes) {
		...
		try {
			...
			vivahNodhaniService.readBooksFromExcelFile(filePath);

...
import com.pcmc.dms.upload.service.PrashanService;

@Controller
public class PrashasanUploadController {
	
	@Autowired
	private PrashanService service;
	
	//Just change department name
	private static final String DEPT_NAME = "Prashasan";

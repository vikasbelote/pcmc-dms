...
import com.pcmc.dms.upload.service.BhuyariService;

@Controller
public class BhuyariUploadController {
	
	@Autowired
	private BhuyariService service;
	
	//Just change department name
	private static final String DEPT_NAME = "Bhuyari";

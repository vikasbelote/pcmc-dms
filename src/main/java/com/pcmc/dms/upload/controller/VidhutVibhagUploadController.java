...
import com.pcmc.dms.upload.service.VidhutVibhagService;

@Controller
public class VidhutVibhagUploadController {
	
	@Autowired
	private VidhutVibhagService service;
	
	//Just change department name
	private static final String DEPT_NAME = "VidhutVibhag";

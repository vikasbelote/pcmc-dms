...
import com.pcmc.dms.upload.service.AuditService;
...
public class AuditUploadController {
	...
	private static final String UPLOAD_URL = "uploadDataAudit";
	...
	public String upload(@RequestParam CommonsMultipartFile file, HttpSession session, final RedirectAttributes redirectAttributes) {
		...
		try {
			...
			auditService.readBooksFromExcelFile(filePath);
	...
	@RequestMapping(value ="/downloadAuditTemplate", method = RequestMethod.GET)
	public ModelAndView downloadTemplate() {
		
		ModelAndView modelAndView = new ModelAndView("auditTemplate", "obj", null);
		return modelAndView;
	}
}

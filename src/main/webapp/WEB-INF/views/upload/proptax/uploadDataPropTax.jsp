...
<h2 class="header blue smaller lighter" style="text-align: center;">Uploading Property Tax
	Data files to server</h2>
<br />
<a href="downloadPropTaxTemplate" style="align: left">Download Template</a>

		...
		<div class="main-content">
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container" style="width: 381px;">
						<div class="center">
							<h1>
								<img src="./static/assets/images/logo.png" /> <img
									src="./static/assets/images/logo-name1.png" />
							</h1>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="space-6"></div>
										<form:form id="login-form" commandName="loginModel" action="validateLogin">
											<fieldset>
...
<![endif]-->
	<script type="text/javascript">
		if ('ontouchstart' in document.documentElement)
			document
					.write("<script src='../static/assets/js/jquery.mobile.custom.js'>"
							+ "<" + "/script>");
	</script>

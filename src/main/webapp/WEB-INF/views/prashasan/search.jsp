...
<div class="col-sm-12">
	<form:form id="some-form" commandName="${MODEL_NAME}"
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<form:select path="tableNumber" class="col-sm-5 form-control">
					<form:option value="" label="Choose Table Number" />
					<form:options items="${tableMasterList}" itemLabel="tableNo"
						itemValue="tableNo" />
				</form:select>
			</div>
		</div>

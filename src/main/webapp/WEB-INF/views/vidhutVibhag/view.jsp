...
<div class="col-sm-4">
	<form:form id="some-form" commandName="${MODEL_NAME}"
		...
		<div class="form-group">
			<label class="col-sm-3 control-label" for="form-field-1">Nividha Number</label>
			<div class="col-sm-9" style="text-align: left;">
				<form:input path="nividhaNumber" class="col-sm-5 form-control" />
			</div>
		</div>
		<div class="form-group">
...
<div class="col-sm-8">
	<c:choose>
		<c:when test="${ sessionScope.print || sessionScope.download }">
			<embed src="./static/images/${ vidhutVibhagModel.getImagePath() }.pdf"
				width="800px" height="600px" style="border: solid 2px black" />
		</c:when>
		<c:otherwise>
			<embed
				src="./static/images/${ vidhutVibhagModel.getImagePath() }.pdf#toolbar=0"
				width="800px" height="600px" style="border: solid 2px black" />
		</c:otherwise>
	</c:choose>
</div>